class Reagent < ActiveRecord::Base
  ...
  has_many :reagent_values, :dependent => :destroy, :order => :reagent_attribute_id
  ...
  attr_accessible :description, :name, :tag_id, :source_id, :reagent_type_id, :isoform_ids, :reagent_values_attributes, :reagent_values
