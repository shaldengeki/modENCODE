class ReagentGroup < ActiveRecord::Base
  ...
  attr_accessible :name, :reagents, :reagents_attributes, :reagent_ids, :users, :user_ids, :users_attributes, :user_tokens, :gene_type_id, :gene_type, :reagent_type_id, :reagent_type, :input_method, :total_reagents
  attr_reader :user_tokens, :reagent_names
  attr_reader :gene_type_id, :reagent_type_id
  attr_accessor :gene_type, :reagent_type, :input_method, :total_reagents
